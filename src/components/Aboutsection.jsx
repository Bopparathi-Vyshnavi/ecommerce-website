...
const Aboutsection = () => {
  return (
    <div className="grid sm:grid-cols-1 gap-10 my-10 lg:grid-cols-2 max-w-7xl">
        <div>
            <img src={aboutimg} alt="" />
        </div>
        <div className="border border-slate-300 px-5 py-10">
            <p className=" text-md text-neutral-500 max-w-3xl">
                ...
                need our care concern and also all the basic needs. We understand <span className="text-orange-400">your love towards your pet</span> and also the troubles you face while pet parenting, which made us set up our vision.</p>
             <p className="mt-5 text-md text-neutral-500 max-w-4xl">
                ...
                It doesn’t matter which pet you have all that matters is you have a pet and we are at your doorstep whenever you order anything for them.</p>
