...
const Travelsection = () => {
  return (
    <div className="mb-10 grid sm:grid-cols-1 gap-10 mt-10 lg:grid-cols-2">
        ...
        <div>
            <h1 className="mt-5 text-4xl sm:text-6xl lg:text-5xl tracking-wide">
            ...
            <div className=" my-10">
                <a href="/About" className="bg-gradient-to-r from-green-500 to-green-800 py-3 px-4  rounded-md">
                    Find more!
                </a>
            </div>
        </div>
